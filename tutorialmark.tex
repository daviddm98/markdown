...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{edidiv <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"edidiv.csv"}\NormalTok{)}
\KeywordTok{summary}\NormalTok{(edidiv)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{ (edidiv)}
\end{Highlighting}
\end{Shaded}

\includegraphics{tutorialmark_files/figure-latex/unnamed-chunk-2-1.pdf}
